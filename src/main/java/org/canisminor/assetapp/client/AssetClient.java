package org.canisminor.assetapp.client;
...
import org.canisminor.assetapp.contract.Asset;
...
public class AssetClient {static Logger logger = LoggerFactory.getLogger(AssetClient.class);
    ...
    public static void Usage() {
        ...
        System.out.println(
                "\t java -cp conf/:lib/*:apps/* org.canisminor.assetapp.client.AssetClient deploy");
        System.out.println(
                "\t java -cp conf/:lib/*:apps/* org.canisminor.assetapp.client.AssetClient query account");
        System.out.println(
                "\t java -cp conf/:lib/*:apps/* org.canisminor.assetapp.client.AssetClient register account value");
        System.out.println(
                "\t java -cp conf/:lib/*:apps/* org.canisminor.assetapp.client.AssetClient transfer from_account to_account amount");
        System.exit(0);
    }
